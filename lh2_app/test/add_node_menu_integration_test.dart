  ...
  group('Add Node Menu Integration', () {
    test('default templates should be available and correctly styled', () {
      ...
      for (final objectType in objectTypes) {
        final templates =
            defaultTemplates.where((t) => t.objectType == objectType).toList();
        expect(templates, isNotEmpty,
            reason: 'Should have templates for $objectType');
      }

      // Test project template specifically
      final projectTemplate =
          defaultTemplates.firstWhere((t) => t.id == 'project-default');
      expect(projectTemplate.objectType, ObjectType.project);
      expect(projectTemplate.name, 'Default Project');

      final style =
          projectTemplate.renderSpec['style'] as Map<String, dynamic>?;
    ...
    test('context requirement template should have conditional port', () {
      ...
      final ports =
          contextTemplate.renderSpec['ports'] as Map<String, dynamic>?;
    ...
    test('templates should follow Figma color scheme', () {
      ...
      final taskStyle =
          taskTemplate.renderSpec['style'] as Map<String, dynamic>?;
      ...
      final deliverableStyle =
          deliverableTemplate.renderSpec['style'] as Map<String, dynamic>?;
      ...
      final sessionStyle =
          sessionTemplate.renderSpec['style'] as Map<String, dynamic>?;
      ...
      final eventTemplate = DefaultNodeTemplates.templates
          .firstWhere((t) => t.id == 'event-default');
      final eventStyle =
          eventTemplate.renderSpec['style'] as Map<String, dynamic>?;
